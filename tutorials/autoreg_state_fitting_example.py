...
model = qk.models.ARqGPS(
    hi,
    2,
    dtype=jnp.complex128,
    count_spins=count_spins_fermionic,
    renormalize_log_psi=renormalize_log_psi_fermionic,
)
...
driver = qk.driver.ARStateFitting(
    dataset, ha, op, variational_state=vs, mini_batch_size=32
)
